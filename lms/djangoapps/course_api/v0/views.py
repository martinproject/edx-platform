...
class CourseContentList(CourseContentMixin, APIViewWithPermissions):
    """
    **Use Case**
...
class CourseContentDetail(CourseContentMixin, APIViewWithPermissions):
    """
    **Use Case**
...
class CourseDetail(CourseContentMixin, APIViewWithPermissions):
    """
    **Use Case**
